  ...
  decorators: [
    (Story, context) => (
      <div className="flex space-x-4">
        ...
        <Story
          args={{ ...context.args, label: "Destructive", variant: "danger" }}
        />
        <Story
          args={{ ...context.args, label: "Cancel", variant: "outlined" }}
        />
...
`,
  ...
  decorators: [
    (Story, context) => (
      <div className="flex space-x-4">
        <Story
          args={{ ...context.args, label: "Login with Email", icon: "mail" }}
        />
        <Story
          args={{
            ...context.args,
        ...
        />
        <Story
          args={{ ...context.args, icon: "plus", onlyIcon: true, pill: true }}
        />
        <Story
          args={{
            ...context.args,
